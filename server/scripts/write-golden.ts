...
const bodies: { [N in keyof EventBodyMap]: EventBodyMap[N] } = {
  ...
  cardPipelineAssigned: { cardId: 'T-1', pipelineId: 'PL-1', stepId: 'st-1' },
  ...
  automationToggled: { pipelineId: 'PL-1', stepId: 'st-2', on: true },
  ...
  pipelineSaved: {
    pipeline: {
      ...
      steps: [
        ...
        { id: 'st-2', kind: 'command' as const, boardVisible: false, command: 'npm test', description: 'Run tests' },
        {
          id: 'st-3',
          kind: 'agent' as const,
          boardVisible: true,
        ...
        { id: 'st-4', kind: 'human' as const, boardVisible: true, description: 'Approval' },
        { id: 'st-5', kind: 'human' as const, boardVisible: true, terminal: true },
      ],
    },
  },
